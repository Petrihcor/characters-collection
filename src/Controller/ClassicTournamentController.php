...
final class ClassicTournamentController extends AbstractController
{
    ...
    public function fight(int $id, Request $request, SessionInterface $session)
    {
        ...
        $result = $this->tournamentService->runClassicTournament2($fighters, $stats, $tournamentData);
